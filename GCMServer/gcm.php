<?php
   ...
   function sendMessageThroughGCM($registatoin_ids, $message) {
		...
		define("GOOGLE_API_KEY", "AIzaSyAig8i1eND9e7751c3usIMY5RrKrh-aYqI"); 		
        $headers = array(
...
<?php
	...
	if(!empty($_GET["push"])) {	
		...
		if (isset($gcmRegID) && isset($pushMessage)) {		
			$gcmRegIds = array($gcmRegID);//echo $pushMessage;
...
<html>
	...
	<body>
		...
		<form method="post" action="gcm.php/?push=true" onsubmit="return checkTextAreaLen()">					                                                      
				<textarea rows="5" name="m" cols="45" placeholder="Message to send via GCM"></textarea> <br/>
